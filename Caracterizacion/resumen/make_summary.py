...
<div class="wrap">
  ...
  <section>
    ...
    <div class="callout"><b>El hallazgo que cambia el alcance: la mano no sostiene cualquier fuerza que alcance.</b> Con el comando congelado, por encima de cierto punto el <b>actuador resbala hacia atrás</b> hasta reenganchar: el pulgar aguanta 1008&nbsp;g durante un segundo entero y entonces retrocede 49 counts de posición en menos de medio segundo, cayendo a 455&nbsp;g. El retroceso de la posición es lo que identifica al culpable — un objeto que se mueve no empuja al dedo contra su propio comando. Los ~3000&nbsp;g de sobreimpulso del Exp 2 y los «≥30&nbsp;N» de la hoja de datos son <b>picos de impacto, no fuerza sostenible</b>.</div>

    <p><b>Pero el punto de resbalón no es un número fijo:</b> se midió en 455&nbsp;g en una pose, ~{_plat:.0f}&nbsp;g en otras dos y 745&nbsp;g en una cuarta, según el dedo y su flexión. Depende de la ventaja mecánica del mecanismo en esa postura. Por debajo de él, en cambio, el sostenimiento es excelente: a 450&nbsp;g durante 60&nbsp;s la fuerza cae solo un {_dropI:.0f}&nbsp;% en el índice y un {_dropT:.0f}&nbsp;% en el pulgar, y a 455&nbsp;g tras reenganchar la deriva fue de <b>1&nbsp;g en 55&nbsp;s</b>. <b>El problema del regulador no es mantener la fuerza: es saber dónde está el borde</b> — y como el borde se mueve, hay que detectarlo vigilando la posición en vez de programar un tope constante.</p>
